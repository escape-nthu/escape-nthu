...
目標：完成至少一種可 demo 的動作辨識關卡。

- [ ] 評估並整合瀏覽器姿態辨識方案。
  - Owner：鄭名緯
  - 驗收：可在 Web build 中取得姿態 keypoints。
- [ ] 實作攝影機權限 UI 與錯誤處理。
  - Owner：鄭名緯
  - 驗收：玩家知道何時需要開啟攝影機。
- [ ] 實作開合跳或指定動作計數。
...
## M6：第三關：Prompt Injection / LLM 線索關

目標：完成受控 LLM 對話解謎。

- [ ] 設計 prompt injection 關卡規則與成功條件。
  - Owner：鄭名緯
